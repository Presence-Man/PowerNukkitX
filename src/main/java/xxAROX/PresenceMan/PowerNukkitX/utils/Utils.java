...
public final class Utils {
    ...
    public static class WebUtils {
        ...
        public static WebRequester.Result get(String url, Map<String, String> headers) {
            WebRequester.init(PresenceMan.GSON, Server.getInstance().getComputeThreadPool());
            try {
                return WebRequester.get(url, headers).get();
            } catch (ExecutionException | InterruptedException e) {
                PresenceMan.getInstance().getLogger().error("Error while executing GET request: ", e);
            }
            return null;
        }
        ...
        public static WebRequester.Result post(String url, Map<String, String> headers, Map<String, String> body) {
            ...
            try {
                ...
                PresenceMan.getInstance().getLogger().error("Error while executing POST request: ", e);
            }
            return null;
        }
    }
