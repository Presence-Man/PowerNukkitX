...
import xxAROX.PresenceMan.PowerNukkitX.EventListener;
import xxAROX.PresenceMan.PowerNukkitX.entity.ActivityType;
import xxAROX.PresenceMan.PowerNukkitX.entity.ApiActivity;
...
import xxAROX.PresenceMan.PowerNukkitX.tasks.async.BackendRequest;
import xxAROX.PresenceMan.PowerNukkitX.tasks.async.FetchGatewayInformationTask;
import xxAROX.PresenceMan.PowerNukkitX.utils.SkinUtils;
...
public final class PresenceMan extends PluginBase {
    ...
    @Override public void onLoad() {
        WebRequester.init(GSON, Server.getInstance().getComputeThreadPool());
        instance = this;
